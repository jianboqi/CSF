...
public:
  ...
  Cloth(const Vec3& origin_pos, int num_particles_width, int num_particles_height, double step_x, double step_y,
  ...
  void handle_slop_connected(std::vector<int> edgePoints, std::vector<XY> connected,
