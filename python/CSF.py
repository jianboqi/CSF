...
class Vecf(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _CSF.Vecf_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _CSF.Vecf___nonzero__(self)
    def __bool__(self): return _CSF.Vecf___bool__(self)
    def __len__(self): return _CSF.Vecf___len__(self)
    def pop(self): return _CSF.Vecf_pop(self)
    def __getslice__(self, *args): return _CSF.Vecf___getslice__(self, *args)
    def __setslice__(self, *args): return _CSF.Vecf___setslice__(self, *args)
    def __delslice__(self, *args): return _CSF.Vecf___delslice__(self, *args)
    def __delitem__(self, *args): return _CSF.Vecf___delitem__(self, *args)
    def __getitem__(self, *args): return _CSF.Vecf___getitem__(self, *args)
    def __setitem__(self, *args): return _CSF.Vecf___setitem__(self, *args)
    def append(self, *args): return _CSF.Vecf_append(self, *args)
    def empty(self): return _CSF.Vecf_empty(self)
    def size(self): return _CSF.Vecf_size(self)
    def clear(self): return _CSF.Vecf_clear(self)
    def swap(self, *args): return _CSF.Vecf_swap(self, *args)
    def get_allocator(self): return _CSF.Vecf_get_allocator(self)
    def begin(self): return _CSF.Vecf_begin(self)
    def end(self): return _CSF.Vecf_end(self)
    def rbegin(self): return _CSF.Vecf_rbegin(self)
    def rend(self): return _CSF.Vecf_rend(self)
    def pop_back(self): return _CSF.Vecf_pop_back(self)
    def erase(self, *args): return _CSF.Vecf_erase(self, *args)
    def __init__(self, *args): 
        this = _CSF.new_Vecf(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _CSF.Vecf_push_back(self, *args)
    def front(self): return _CSF.Vecf_front(self)
    def back(self): return _CSF.Vecf_back(self)
    def assign(self, *args): return _CSF.Vecf_assign(self, *args)
    def resize(self, *args): return _CSF.Vecf_resize(self, *args)
    def insert(self, *args): return _CSF.Vecf_insert(self, *args)
    def reserve(self, *args): return _CSF.Vecf_reserve(self, *args)
    def capacity(self): return _CSF.Vecf_capacity(self)
    __swig_destroy__ = _CSF.delete_Vecf
    __del__ = lambda self : None;
Vecf_swigregister = _CSF.Vecf_swigregister
Vecf_swigregister(Vecf)

class VecVecf(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, VecVecf, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, VecVecf, name)
    __repr__ = _swig_repr
    def iterator(self): return _CSF.VecVecf_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _CSF.VecVecf___nonzero__(self)
    def __bool__(self): return _CSF.VecVecf___bool__(self)
    def __len__(self): return _CSF.VecVecf___len__(self)
    def pop(self): return _CSF.VecVecf_pop(self)
    def __getslice__(self, *args): return _CSF.VecVecf___getslice__(self, *args)
    def __setslice__(self, *args): return _CSF.VecVecf___setslice__(self, *args)
    def __delslice__(self, *args): return _CSF.VecVecf___delslice__(self, *args)
    def __delitem__(self, *args): return _CSF.VecVecf___delitem__(self, *args)
    def __getitem__(self, *args): return _CSF.VecVecf___getitem__(self, *args)
    def __setitem__(self, *args): return _CSF.VecVecf___setitem__(self, *args)
    def append(self, *args): return _CSF.VecVecf_append(self, *args)
    def empty(self): return _CSF.VecVecf_empty(self)
    def size(self): return _CSF.VecVecf_size(self)
    def clear(self): return _CSF.VecVecf_clear(self)
    def swap(self, *args): return _CSF.VecVecf_swap(self, *args)
    def get_allocator(self): return _CSF.VecVecf_get_allocator(self)
    def begin(self): return _CSF.VecVecf_begin(self)
    def end(self): return _CSF.VecVecf_end(self)
    def rbegin(self): return _CSF.VecVecf_rbegin(self)
    def rend(self): return _CSF.VecVecf_rend(self)
    def pop_back(self): return _CSF.VecVecf_pop_back(self)
    def erase(self, *args): return _CSF.VecVecf_erase(self, *args)
    def __init__(self, *args): 
        this = _CSF.new_VecVecf(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _CSF.VecVecf_push_back(self, *args)
    def front(self): return _CSF.VecVecf_front(self)
    def back(self): return _CSF.VecVecf_back(self)
    def assign(self, *args): return _CSF.VecVecf_assign(self, *args)
    def resize(self, *args): return _CSF.VecVecf_resize(self, *args)
    def insert(self, *args): return _CSF.VecVecf_insert(self, *args)
    def reserve(self, *args): return _CSF.VecVecf_reserve(self, *args)
    def capacity(self): return _CSF.VecVecf_capacity(self)
    __swig_destroy__ = _CSF.delete_VecVecf
    __del__ = lambda self : None;
VecVecf_swigregister = _CSF.VecVecf_swigregister
VecVecf_swigregister(VecVecf)
