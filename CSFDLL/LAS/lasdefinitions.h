...
public:
  ...
  {
	  strcpy_s(file_signature, pheader.file_signature);
	  ...
	  strcpy_s(project_ID_GUID_data_4, pheader.project_ID_GUID_data_4);

	  version_major = pheader.version_major;
	  version_minor = pheader.version_minor;
	  strcpy_s(system_identifier, pheader.system_identifier);
	  strcpy_s(generating_software, pheader.generating_software);
